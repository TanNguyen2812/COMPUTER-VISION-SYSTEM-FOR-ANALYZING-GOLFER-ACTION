...
class mstcn(nn.Module):
    ...
    def __init__(self,
        ...
        for i, cfg in enumerate(ms_cfg):
            ...
            branch = nn.ModuleList([nn.Conv2d(in_channels, branch_c, kernel_size=1), nn.BatchNorm2d(branch_c), self.act,
...
class ST_GCN(nn.Module):
    ...
    def __init__(self, in_channels=2, embedding_size=128, kernel_size=3):
