...
class unit_tcn(nn.Module):
    ...
    def __init__(self, channels, kernel_size=9, stride=1, dilation=1, dropout=0.1):
        super().__init__()
    ...
    def __init__(self,
        ...
        for i, cfg in enumerate(ms_cfg):
            ...
            branch = nn.Sequential(
                nn.Conv2d(in_channels, branch_c, kernel_size=1), nn.BatchNorm2d(branch_c), self.act,
                unit_tcn(branch_c, kernel_size=cfg[0], stride=stride, dilation=cfg[1]))
...
class ST_GCN(nn.Module):
    ...
    def __init__(self, in_channels, n_classes):
        ...
        self.data_bn1 = nn.BatchNorm2d(in_channels)
        self.data_bn2 = nn.BatchNorm2d(in_channels)
        self.data_bn3 = nn.BatchNorm2d(in_channels)
        ...
        self.l4 = st_gcn_unit(90, 100, A, ms_cfg=[(9, 1), (3, 2 ** 4), (3, 2 ** (8 - 4))])
        self.l5 = st_gcn_unit(100, 100, A, ms_cfg=[(9, 1), (3, 2 ** 5), (3, 2 ** (8 - 5))])
        self.l6 = st_gcn_unit(100, 100, A, ms_cfg=[(9, 1), (3, 2 ** 6), (3, 2 ** (8 - 6))])
        self.l7 = st_gcn_unit(100, 100, A, ms_cfg=[(9, 1), (3, 2 ** 7), (3, 2 ** (8 - 7))])
        self.l8 = st_gcn_unit(100, 100, A, ms_cfg=[(9, 1), (3, 2 ** 8), (3, 2 ** (8 - 8))])
        # self.l9 = st_gcn_unit(100, 100, A, ms_cfg=[(9,1), (3, 2**9)])
        ...
        # self.l8 = st_gcn_unit(64, 100, A, ms_cfg=[(9,1), ])
        # self.l9 = st_gcn_unit(100, 128, A, ms_cfg=[(9,1), ])
...
if __name__ == '__main__':
    model = ST_GCN(in_channels=3, n_classes=3)